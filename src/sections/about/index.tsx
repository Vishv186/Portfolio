        ...
        >
            ...
            <div className='relative flex flex-col items-center sm:flex-row w-full max-w-180 gap-10 p-10 surface-styles'>
                ...
                <div className='flex flex-col gap-4 w-full sm:w-[65%] justify-center text-text font-normal'>
                    <p>
                        I am a Full-Stack JavaScript Developer located in Pune,
                        Maharashtra, India. I enjoy using modern technologies to
                    ...
                    <p>
                        Away from my computer, I love playing Football. I like
                        to push myself physically and mentally. I also enjoy
                        other outdoor activities such as hiking, Swimming and
                        photography. A healthy, balanced lifestyle is something
                        I highly value.
                    </p>
